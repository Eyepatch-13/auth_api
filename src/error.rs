...
impl ErrorMessage {
    fn to_str(&self) -> String {
        match self {
            ...
            ErrorMessage::ExceededMaxPasswordLength(length) => format!("Password must be at most {} characters long", length),
            ErrorMessage::HashingError => "Error occured while hashing password".to_string(),
